export function Navbarr() {
    ...
    return (
        ...
        <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://utfs.io/f/786bdb1f-2aa6-4566-8396-0487e72b05a3-t2zciv.gif" className="h-8" alt="wumpy dumpies eating thingy bignsofisodfiosdf" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Wumpus Blog</span>
        </a>
        <a href="https://discord.gg/cTsCYmdg6z" className="glassmorphism inline-flex items-center space-x-2 px-4 py-2 bg-black border border-zinc-900 rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-zinc-950 focus:ring-2 focus:ring-zinc-950 focus:ring-opacity-50">
